...
with st.sidebar:
    ...
    st.success("Abhay Kumar Gupta")

    st.markdown("---")

    st.markdown("### 📂 Project Links")

    github_url = "https://github.com/Abhay-cody/AI_ML_PROJECTS/tree/main/Project_10_RAG_Chatbots_for_Health_Insurance"

    linkedin_url = "https://www.linkedin.com/in/abhay-kumar-gupta-104a18397"
...
st.markdown(
    '<p class="main-title">🏥 Health Insurance RAG Chatbot</p>',
    unsafe_allow_html=True,
)
...
with col1:
    ...
    try:
        ...
        st.markdown(
            "[📂 GitHub Repository](https://github.com/Abhay-cody/AI_ML_PROJECTS/tree/main/Project_10_RAG_Chatbots_for_Health_Insurance)"
        )
...
st.caption(
    "© 2026 Abhay Kumar Gupta | Health Insurance RAG Chatbot"
)
